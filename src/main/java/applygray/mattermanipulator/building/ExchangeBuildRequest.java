...
/** Server-authoritative input for a bounded exchange operation. */
public record ExchangeBuildRequest(EntityPlayer player, ItemStack manipulatorStack, EnumHand hand,
                                   ManipulatorTier tier, ManipulatorState state,
                                   List<? extends MaterialSource> materialSources, PowerSource powerSource) {

    public ExchangeBuildRequest {
