...
/** Server-authoritative input for an atomic move operation. */
public record MoveBuildRequest(EntityPlayer player, ItemStack manipulatorStack, EnumHand hand, ManipulatorTier tier,
                               ManipulatorState state, List<? extends MaterialSource> materialSources,
                               PowerSource powerSource) {

    public MoveBuildRequest {
