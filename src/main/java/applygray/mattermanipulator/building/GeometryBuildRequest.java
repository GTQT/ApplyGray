...
/** Server-authoritative input for one bounded geometry build batch. */
public record GeometryBuildRequest(EntityPlayer player, ItemStack manipulatorStack, EnumHand hand,
                                   ManipulatorTier tier, ManipulatorState state,
                                   List<? extends MaterialSource> materialSources, PowerSource powerSource) {

    public GeometryBuildRequest {
